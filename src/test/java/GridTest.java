import backend.logic.Field;
import backend.logic.Grid;
...
class GridTest {
    ...
    void placeStoneOnStone() {
        try {
            grid.placeStone(0, 0, new Stone(GameInterface.COLOUR_BLACK));
        } catch (IllegalMoveException e) {
    ...
    void placeStoneOutsideTheField() {
        IllegalMoveException thrown = Assertions.assertThrows(IllegalMoveException.class, () -> {
            grid.placeStone(-1, 8, new Stone(GameInterface.COLOUR_BLACK));
        }, "interfaces.IllegalMoveException was expected");
    ...
    void placeStoneInsideTheFieldButAtAnInvalidOne() {
        IllegalMoveException thrown = Assertions.assertThrows(IllegalMoveException.class, () -> {
            grid.placeStone(0, 1, new Stone(GameInterface.COLOUR_BLACK));
        }, "interfaces.IllegalMoveException was expected");
    ...
    void removeAStone() {
        try {
            grid.placeStone(3, 4, new Stone(GameInterface.COLOUR_WHITE));
        } catch (IllegalMoveException e) {
    ...
    void jumpStone() {
        ...
        try {
            grid.placeStone(1, 3, new Stone(GameInterface.COLOUR_WHITE));
        } catch (IllegalMoveException e) {
            fail("Expected no exception, got: " + e.getMessage());
        }
    ...
    void getField() {
        ...
        try {
            grid.placeStone(0, 0, new Stone(GameInterface.COLOUR_WHITE));
            grid.placeStone(1, 1, new Stone(GameInterface.COLOUR_BLACK));
            grid.placeStone(1, 5, new Stone(GameInterface.COLOUR_BLACK));
        } catch (IllegalMoveException e) {
            fail("Expected no exception, got: " + e.getMessage());
        }

        result = grid.getGrid();
        assertEquals(result[0][0].getStone().getColour(), GameInterface.COLOUR_WHITE);
        assertEquals(result[1][1].getStone().getColour(), GameInterface.COLOUR_BLACK);
        assertEquals(result[5][1].getStone().getColour(), GameInterface.COLOUR_BLACK);
    ...
    void validityCheckOfFields() {
        IllegalMoveException thrown = Assertions.assertThrows(IllegalMoveException.class, () -> {
            grid.placeStone(4, 5, new Stone(GameInterface.COLOUR_WHITE));
        }, "interfaces.IllegalMoveException was expected");
        ...
        thrown = Assertions.assertThrows(IllegalMoveException.class, () -> {
            grid.placeStone(6, 5, new Stone(GameInterface.COLOUR_WHITE));
        }, "interfaces.IllegalMoveException was expected");
        ...
        try {
            grid.placeStone(5, 3, new Stone(GameInterface.COLOUR_WHITE));
            grid.placeStone(4, 4, new Stone(GameInterface.COLOUR_BLACK));
            grid.placeStone(6, 3, new Stone(GameInterface.COLOUR_BLACK));
        } catch (IllegalMoveException e) {
            fail("Expected no exception, got: " + e.getMessage());
        }
    }
    ...
    void getAdjacentFields() {
        ...
        try {
            grid.placeStone(1, 3, new Stone(GameInterface.COLOUR_WHITE));
            grid.placeStone(1, 5, new Stone(GameInterface.COLOUR_BLACK));
            grid.placeStone(2, 3, new Stone(GameInterface.COLOUR_WHITE));
            grid.placeStone(0, 3, new Stone(GameInterface.COLOUR_BLACK));
            grid.placeStone(1, 1, new Stone(GameInterface.COLOUR_WHITE));
